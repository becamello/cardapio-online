...
var CELULAR_EMPRESA = '5521973122367';
...
cardapio.metodos = {
    ...
    // diminuir a quantidade de itens do cardapio
    ...
    // aumentar a quantidade de itens do cardapio
    ...
    adicionarAoCarrinho: (id) => {
        ...
        if (qntdAtual > 0) {
            ...
            if (item.length > 0) {
                ...
                // caso já exista o item no cariinho, só altera a quantidade
                if (existe.length > 0 ) {
                    let objIndex = MEU_CARRINHO.findIndex((obj => obj.id == id));
                    MEU_CARRINHO[objIndex].qntd = MEU_CARRINHO[objIndex].qntd + qntdAtual;
                }
                // caso ainda não exista o item no cariinho, adiciona ele
                else {
    ...
    //atualiza o badge de totais dos botãoes "meu carrinho"
    atualizarBadgeTotal: () => {
